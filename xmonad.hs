...
myStartupHook = do 
    ...
    spawnOnce "/usr/bin/trayer --edge top --align left --SetDockType true --SetPartialStrut true --expand true --widthtype request --transparent true --alpha 50 --tint 000000 --height 19 --monitor primary"
